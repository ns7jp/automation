...
難易度・目安時間は、各演習の `meta.env` に書かれている値と同じものです(「新しく学ぶ概念」の欄は、演習どうしの関係が見えやすいように要約しています。正確な記載は各演習の `meta.env` と README を参照してください)。手元でも確認できます。
...
約9時間で全体の骨格を通したい場合は、次の10演習に絞ってください。各ステージの中心となる演習だけを選んでいます。
